...
const hayDolarAhorro = ['2020-02-02', '2020-08-15', '2021-02-15','2021-08-23', '2022-02-21', '2023-01-07', '2023-07-07'];
    ...
    { // category
        ...
        content: (
            <div>
                ...
                <p>
                    A continuación te mostramos los resultados del nuevo análisis para junio - julio 2023.
                </p>
                <br />
    ...
    { // category
        ...
        data: [
                    ...
                    {  // section
                        ...
                        data: [
                            {  // tab
                                ...
                                Se observan valores similares a los de la <a href="https://sueldos.openqube.io/encuesta-sueldos-2023.01/" target="_blank" rel="noopener noreferrer">encuesta anterior</a>.
                                </p>)
                            },
                        ],
                    },
                    {  // section
                        ...
                        data: [
                            {  // tab
                                ...
                                description: (<div>
                                        <p>
                                            Más del 50% de las personas encuestadas tiene 3 o menos años en su compañía actual.
                                        </p>
                                </div>)
                            },
                        ],
            ...
            { // sub-category
                ...
                content: (
                    <div>
                        <p>Del total de las respuestas consideradas, sólo un {charts['ans_educ_percent']}% de lxs encuestadxs respondieron la sección de educación. Esto corresponde a {charts['ans_educ']} respuestas.</p>
                    </div>
                ),
                data: [
                    {  // section
                        ...
                        data: [
                            {  // tab
                                ...
                                caption: 'Este gráfico permite ver qué porcentaje del total de personas encuestadas alcanzó cada nivel de estudios.  A su vez, por cada una, podemos apreciar el grado de completitud o estado de sus carreras.',
                                description: (
                                    <div>
                                        <p>Con el objetivo de no distorsionar el análisis, aquí se utiliza la escala de representación lineal.</p>
                                        <p>
                                            Aproximadamente el 30% de las personas encuestadas no ha finalizado estudios universitarios.
                                            <br></br>
                                            La tendenciase mantiene respecto de la <a href="https://sueldos.openqube.io/encuesta-sueldos-2023.01/" target="_blank" rel="noopener noreferrer">encuesta anterior</a>.
                                        </p>
                            ...
                            { // tab
                                ...
                                description: (<div>
                                    <p>
                                        ...
                                        Datos presentados en <a href="#Metodologia">escala logarítmica</a>.
                                    </p>
                                </div>),
                            },
                            { // tab
    ...
    { // category
        ...
        data: [
            { // sub-category
                ...
                content: (
                    <div>
                        ...
                        <p>En los siguientes gráficos podremos ver cómo fueron cambiando las medianas salariales y contrastarlas a su vez con su correspondiente valor en dólares según la cotización de cada período.</p>
                    </div>
                ),
                data: [
                    {  // section
                        ...
                        data: [
                            {  // tab
                                ...
                                description: <p>
                                    Observando la tendencia histórica es inevitable notar el drástico aumento en la pendiente de la curva de salarios a partir del año 2022. Desde enero de 2022 hasta junio de 2023 se registró en la República Argentina una inflación de <a target="_blank" rel="noopener noreferrer" href="https://calculadoradeinflacion.com/"> 177%</a> según el <a target="_blank" rel="noopener noreferrer" href="https://www.indec.gob.ar/">INDEC</a>. Según los datos históricos de esta encuesta, en aproximadamente el mismo intervalo de tiempo, la mediana salarial aumentó un 165%.
                                    <br></br>
                                    <br></br>
                    ...
                    {  // section
                        ...
                        data: [
                            {  // tab
                                ...
                                description: <div>
                                    <p>
                                        Las medianas salariales para las diferentes experiencias varían entre un 25% y un 61% según si el sueldo se encuentra (al menos en una parte) dolarizado o no. Para más detalle ver <a href="#Metodologia">Metodología</a>.
                                    </p>
                                    <p>
            ...
            { // sub-category
                ...
                content: (
                    <div>
                        <p>Dada la diferencia salarial observada entre los sueldos en pesos argentinos y los que están (al menos en una parte) dolarizados, se muestra a continuación las medianas salariales según rol, experiencia y el estado de dolarización del sueldo.  </p>
                    </div>
                ),
                data: [
                    {  // tab
                        ...
                        data: [
                            {  // tab
                                ...
                                props: {
                                    ...
                                    currency: 'AR$',
                                    markNegativeValues: ['Dolarizado', 'No Dolarizado'],
                                    
                                },
                                caption: 'Mediana salarial por nivel de educación formal alcanzado y según sueldos dolarizados.',
    ...
    { // category
        ...
        content: (
            <div>
                ...
                <ul>
                    ...
                    <li>Fluido 0,2%</li>
                    <li>Mujer trans 0,1%</li>
                </ul>
                <p>Como es de esperar, las inequidades históricas y sistemáticas por género, se sostienen.</p>

                <h4>Algunos datos</h4>
                <ol>
                    <li>De las personas que participaron de la encuesta y respondieron este ítem, el ~77% son hombres cis, mientras que el ~17,5% son mujeres cis y el 0,6% personas no binaries. </li>
                    <li>Se observa un incremento de participación de ~1% de mujeres cis con respecto al período anterior.</li>
        ...
        data: [
                        ...
                        data: [
                            {  // tab
                                ...
                                description: (<div>
                                    ...
                                    El gráfico nos muestra que, al día de hoy, por cada peso que gana un hombre cis, una mujer cis gana 80 centavos.
                                    <p>
                                    Tener en cuenta, al analizar el gráfico, que las personas de géneros no binaries representan el 0,6% de la muestra.
                                    </p>
                            ...
                            {  // tab
                                ...
                                description: (<div>
                                    ...
                                    El gráfico nos muestra que, al día de hoy, por cada dólar estadounidense que gana un hombre cis, una mujer cis gana 80 centavos de dólar.
                                    <p>
                                    Tener en cuenta, al analizar el gráfico, que las personas de géneros no binaries representan el 0,6% de la muestra.
                                    </p>
                            ...
                            {  // tab
                                ...
                                description: (<div>
                                    ...
                                    El gráfico nos muestra que por cada dólar estadounidense que gana un hombre cis, una mujer cis gana 80 centavos de dólar.
                                    <p>
                                    Tener en cuenta, al analizar el gráfico, que las personas de géneros no binaries representan el 0,6% de la muestra.
                                    </p>
            ...
            { // sub-category
                ...
                data: [
                    {  // section
                        title: 'Ajustes por inflación 2023',
                        data: [
                            {  // tab
                                title: '',
                                component: 'Barh', // graph
                                ...
                                description: <>
                                    <p>
                                        Como contraste, la inflación publicada por el <a href="https://www.indec.gob.ar/" target="_blank" rel="noopener noreferrer">INDEC</a> desde enero 2023 hasta junio 2023 fue de <strong>42,22%</strong>.
                                    </p>
                                    <p>
                                    Aquellas personas que se identifican como hombres cis tuvieron un 1% más de ajuste que las mujeres cis y un 5% por sobre persona de géneros no binaries.
                                    </p>
                                    <p>
                                    <small>
                    ...
                    {  // section
                        ...
                        data: [
                            {  // tab
                                ...
                                description: <div> Se define posición de liderazgo (Sí) la que tiene al menos 1 persona a su cargo. Dejamos expresados los porcentajes de las personas que se reconocen como no binarie y que prefieren no responder.</div>,
                            },
                        ],
                    },
        ...
        data: [
                    ...
                    {  // section
                        ...
                        data: [
                            { // tab
                                ...
                                description: <p>El 34% de las personas tiene su sueldo dolarizado, al menos de manera parcial. Esto representa un incremento del 8% respecto a la <a href="https://sueldos.openqube.io/encuesta-sueldos-2023.01/" target="_blank" rel="noopener noreferrer">encuesta anterior</a>.</p>,
                            },
                        ],
                    },
                    {
            ...
            { // sub-category
                ...
                data: [
                    ...
                    {  // section
                        title: 'Porcentajes de Ajuste por Inflación a la fecha (2023)',
                        data: [
                            {  // tab
                                title: '',
                                component: 'Barh', // graph
                                ...
                                description:(
                                    <div>
                                        Inflación acumulada en 2023: <strong>42,22%</strong>.
                                        <p>
                                            <small>
                                        Es importante tomar este numero con ciudado ya que en muchos casos no es posible distinguir si el sueldo está o no dolarizado y posiblemente existan
                                        casos donde, por tratarse de un sueldo dolarizado, no hubo ajustes por inflación.
                            ...
                            {  // tab
                                ...
                                description:(
                                    <div>
                                        ...
                                        <p>
                                        Aproximadamente el 47% de las personas trabaja en empresas con menos de 200 empleados.
                                        </p>
                                    </div>
                                ),
                            },
                        ...
                        data: [
                            {  // tab
                                ...
                                description:(
                                    <div>
                                        <p>
                                        El 58% de las personas encuestadas trabaja remoto y el 35% trabaja bajo un esquema híbrido.
                                        </p>
                                    </div>
                                ),
                            },
